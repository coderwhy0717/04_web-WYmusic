  ...
  return (
    <AlbumWrapper size={size} bgp={bgp} width={width}>
      <div className='album-image'>
          ...
          <NavLink className='cover image_cover' to={`/discover/albumDetail/${info.id}`}></NavLink>
          <i className='play sprite_icon'></i>
      </div>
      <div className='album-info text-nowrap'>
      <NavLink className='name text-nowrap' to={`/discover/albumDetail/${info.id}`}>{info.name}</NavLink>
