...
function reducer(state = defaultState, action) {
  switch (action.type) {
    ...
    case actionType.LOGIN_SHOW_WINDOW:
      return state.set('LoginShowWindow', action.data)
    case actionType.USER_EVENT_LIST:
      return state.set('EventList', action.list)
    case actionType.USER_FANS_LIST:
      return state.set('FansList', action.list)
    case actionType.USER_FOLLOWS_LIST:
      return state.set('FollowsList', action.list)
    default:
      return state
  }
}
