...
const defaultState = Map({
  playList: [
    ...
    },
    {
      ...
      al: {
        ...
        name: '天外来物',
        picUrl:
          'https://p1.music.126.net/MgH6SepYHboKPr6FR8yg-w==/109951167040040692.jpg',
        tns: [],
        pic_str: '109951167040040692',
        pic: 109951167040040690
      },
      dt: 257253,
      h: {
        br: 320000,
    ...
    },
    {
      ...
      al: {
        ...
        name: '绅士',
        picUrl:
          'https://p1.music.126.net/5l-jJhvxFTwrT_Y0ywo7ZQ==/109951168050911647.jpg',
        tns: [],
  ...
  currentSongIndex: 0,
  currentSong: {},
  sequence: 0, //0顺序播放 1 随机 2 单曲
  playLyrics: [{ time: 0, content: '请播放Music,显示歌词' }], //当前播放歌词
  pagesLyrics: [], // 歌曲页面歌词
  lyricsIndex: 0,
  // 详情页点击一样的歌曲播放 playIcon
  onplaying: false,
  // 遮罩层
  maskCover: false
  //  手机端APP 点击歌曲名字进入详情页
...
function reducer(state = defaultState, action) {
  switch (action.type) {
    ...
    case actionType.CHANGE_CURRENT_SONG:
      return state.set('currentSong', action.songs)
    case actionType.CHANGE_PLAY_LYRICS:
      return state.set('playLyrics', action.lyrics)
    case actionType.CHANGE_PAGES_LYRICS:
      return state.set('pagesLyrics', action.lyrics)
    case actionType.CHANGE_LYRICS_INDEX:
      return state.set('lyricsIndex', action.index)
    case actionType.CHANGE_ONPLAYING:
