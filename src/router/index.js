  ...
  },
    {
      ...
      routes:[
        ...
        },
        {
          ...
          exact:true,
          render:() => (
            <Redirect to='/discover/Ranking/19723756' />
          )
        },
        {
        ...
        },
        {
          ...
          component:React.lazy(() => import('@/pages/discover/other-pages/song-list-details'))
        },
        {
          path:'/discover/playSong/:id',
          component:React.lazy(() => import('@/pages/discover/other-pages/song-details'))
        },
        {
          path:'/discover/artistDetail/:id',
          component: React.lazy(() => import('@/pages/discover/other-pages/artist-details'))
        },
        {
          path:'/discover/albumDetail/:id',
          component: React.lazy(() => import('@/pages/discover/other-pages/album-details'))
        }
      ]
    },
    {
